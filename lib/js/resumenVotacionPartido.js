 ...
 */
 ...
 var columnas = [
	{header: "C&oacute;digo", width: 80, sortable: true, dataIndex: 'codpartido'},
	{header: "Partido", width: 300, sortable: true, dataIndex: 'descripcion'},
 ...
 var gdVotaPartido = new Ext.grid.GridPanel({
	...
	height     : 300,
	width      : 480,
	tbar       : genBarraExportar('votaPartMunicipio'),
