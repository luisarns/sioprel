	...
	var menuPrincipal = [
	{
		...
		children : [
		{
			...
			tabType : 'load',
			draggable : false,
			text : 'Consolidado Partido Lista',
			leaf : true
		},
		// {
			// text : 'Punto 1',
			...
			children : [
				{
					...
					tabType : 'load',
					draggable : false,
					text : 'Resumen Curules Asignadas',
					leaf : true
				}
			]
		},
			...
			children : [
				{
					...
					tabType : 'load',
					draggable : false,
					text : 'Elegidos y Asignacion Curules',
					leaf : true
				}
			]
		}
			...
			},
			{
				...
				listeners       : {
					click : function(node) {
						...
						} else if (node.attributes.id == 'resecuruparti'){
							actualizarPanel('central',URL_SIPREL+'html/resumenCurulesPartido.html');
						}else if(node.attributes.id == 'eleasigcurules'){
							actualizarPanel('central',URL_SIPREL+'html/elegidosAsignacionCurules.html');
						}
					}
				},
				selectable    : true,
