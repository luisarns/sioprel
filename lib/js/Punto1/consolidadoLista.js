/**
 * Formulario consolidadoLista.js cuya funciones es:
 * presentar la votacion de las listas a nivel departamental
 * municipal, zonal, comuna, puesto y mesa
 * 
 ...
 */
 ...
 function getGrid(){
	...
	var store = new Ext.data.JsonStore({
		url      : URL_SIPREL+'controladores/Punto1/consolidadoLista.php',
		autoLoad : false,
		fields   : [
		   {name : 'divipol'},
		   {name : 'corporacion'},
	...
	var grid = new Ext.grid.GridPanel({
		store      : store,
		columns    : [
			{ header : "Divisi&oacute;n Pol&iacute;tica",     width : 100, sortable : true, dataIndex : 'divipol' },
			{ header : "Corporaci&oacute;n", width : 110, sortable : true, dataIndex : 'corporacion'  },
			{ header : "Nombre",       width : 230, sortable : true, dataIndex : 'descripcion' },
			{ header : "Votos",         width : 80, sortable : true, dataIndex : 'votos'   }
		],
		tbar         : genBarraExportar('Punto1/consolidadoLista'),
		plugins      : buscarPlugin(),
		stripeRows   : true,
		autoScroll   : true,
		border       : true,
		...
		height       : 350,
		width        : 550,
		title        : 'Listado Consolidado Listas'
	});
	return grid;
 }
 ...
 gdConsolidadoPartido.render('idgridconsollista');