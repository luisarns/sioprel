 ...
 * @version   1.0.0
 */
 //--Objeto js que contiene los parametros de la ultima peticion enviada al servidor
 var parametros = {};
 ...
 function getGrid(){
	...
	var store = new Ext.data.JsonStore({
		url      : URL_SIPREL+'controladores/Punto1/consolidadoPartido.php',
		autoLoad : false,
		fields   : [
		   {name : 'divipol'},
		   {name : 'codigo'},
	...
	var grid = new Ext.grid.GridPanel({
		store      : store,
		columns    : [
			{ header : "Ubicacion",     width : 115, sortable : true, dataIndex : 'divipol' },
			{ header : "C&oacute;digo", width : 130, sortable : true, dataIndex : 'codigo'  },
			{ header : "Partido",       width : 100, sortable : true, dataIndex : 'partido' },
			{ header : "Votos",         width : 130, sortable : true, dataIndex : 'votos'   }
		],
		tbar         : genBarraExportar('Punto1/consolidadoPartido'),
		plugins      : buscarPlugin(),
		stripeRows   : true,
		autoScroll   : true,
		border       : true,
 ...
 gdConsolidadoPartido.render('idgridconsolpartid');
