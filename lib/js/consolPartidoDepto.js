 ...
 */
 ...
 function crearGridCandidatos(){
	...
	// var myData = [
		// ['001','MOISES','ARTUNDUAGA ESCOBAR','INSCRIPTO'],
		// ['002','FRANCISCO','GONZALES PENAGOS','INSCRIPTO'],
		// ['003','WILMER','ROJAS','INSCRIPTO'],
		// ['004','CARMENZA','MENDEZ LOPEZ','INSCRIPTO']
	// ];
 ...
 });//Recordar poner el codigo del partido para hacer el filtro de candidatos
 ...
 //crear un metodo que me genere una grid de candidatos
 //esta funcion recibe como parametro el titulo de la grid
 //un parametro estado (elegido,avalado), y retorna la grid ya que las 2 tendran los mismos datos
